...
## Overview
Audit trails record and display a transparent history of AI actions, decisions, user interactions, and reasoning and data wherever possible for accountability and learning. They make AI behavior observable after the fact by logging what happened, when, why, and who was involved — and by clearly distinguishing AI actions from human ones.

---
## Purpose and value
---
## When to use
- **Providing a history of actions taken and even proposed by the AI system:** Log agent steps, tool calls, recommendations applied, and resource changes recorded after the fact. <a href="#assumptions" class="assumption-marker" style="color:#ee0000;font-weight:700;text-decoration:none">*</a>
...
- **Real-time reasoning visibility:** Loading states, transient progress, and short-lived status toasts are not audit trails. Use progress indicators instead. <a href="#assumptions" class="assumption-marker" style="color:#ee0000;font-weight:700;text-decoration:none">*</a>
